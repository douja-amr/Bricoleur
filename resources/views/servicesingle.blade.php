                        ...
                        <div class="portfolio-grid-layout2">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="portfolio-item">
                                        <div class="portfolio__img">
                                            <img src="{{ asset('images/peint1.jpg')}}" alt="portfolio img">
                                        </div>
                                        <!-- /.portfolio-img -->
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="portfolio-item">
                                        <div class="portfolio__img">
                                            <img src="{{ asset('images/peint2.jpg')}}" alt="portfolio img">
                                        </div>
                                        <!-- /.portfolio-img -->
                                        <div class="portfolio__content">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="portfolio-item">
                                        <div class="portfolio__img">
                                            <img src="{{ asset('images/peint3.jpg')}}" alt="portfolio img">
                                        </div>
                                        <!-- /.portfolio-img -->
                                        <div class="portfolio__content">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="portfolio-item">
                                        <div class="portfolio__img">
                                            <img src="{{ asset('images/peint4.jpg')}}" alt="portfolio img">
                                        </div>
                                        <!-- /.portfolio-img -->
                                        <div class="portfolio__content">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6 portfolio-hidden">
                                    <div class="portfolio-item">
                                        <div class="portfolio__img">
                                            <img src="{{ asset('images/peint5.jpg')}}" alt="portfolio img">
                                        </div>
                                        <!-- /.portfolio-img -->
                                        <div class="portfolio__content">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6 portfolio-hidden">
                                    <div class="portfolio-item">
                                        <div class="portfolio__img">
                                            <img src="{{ asset('images/peint6.jpg')}}" alt="portfolio img">
                                        </div>
                                        <!-- /.portfolio-img -->
                                        <div class="portfolio__content">
